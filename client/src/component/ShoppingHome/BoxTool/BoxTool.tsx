...
type BoxToolProps = {
	...
	setSort: (value: 'relevant' | 'lowestprice' | 'highestprice' | 'popular' | 'newest') => void;
	categories: string[];
	setCategories: (value: string[]) => void;
	setPage: (value: number) => void;
};
function BoxTool({ setSort, categories, setCategories, setPage }: BoxToolProps) {
				...
				<Group>
					<SegmentedControl
						...
						onChange={(value) => {
							...
							setSort(
								value
									? (value as 'relevant' | 'lowestprice' | 'highestprice' | 'popular' | 'newest')
									: 'relevant'
							);
						}}
					/>
