      ...
      >
        ...
        >
          <Tooltip label="Social" position="right" withArrow>
            <IconSocial
              size={40}
              className={`${classes.icon} appear icon-1`}
              stroke={1.2}
            />
          </Tooltip>
          <Tooltip label="Shopping" position="right" withArrow>
            <IconShoppingCart
              size={40}
              stroke={1.2}
              className={`${classes.icon} appear icon-2`}
            />
          </Tooltip>
          <Tooltip label="FAQ" position="right" withArrow>
            <IconHelpHexagonFilled
              size={40}
          ...
          <Tooltip label="Contact" position="right" withArrow>
            <IconAddressBook
              size={40}
              className={`${classes.icon} appear icon-4`}
              stroke={1.2}
            />
          </Tooltip>
        </SimpleGrid>
